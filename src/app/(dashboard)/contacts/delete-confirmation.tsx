...
export function DeleteConfirmation({ contact, loading, onConfirm, onCancel }: DeleteConfirmationProps) {
  // Close on Escape
  React.useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 animate-[scaleIn_0.2s_ease-out]">
        {/* Close button */}
        <button
          onClick={onCancel}
          disabled={loading}
